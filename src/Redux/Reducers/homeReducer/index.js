import {ADD_TO_CART, GETCART, GETDATA, SETCART, SETDATA, SET_ADD_TO_CART} from "../../Actions/HomeActions/actionStates";
...
const homeReducer = (data = initialData,action) => {
    ...
    switch(action.type){
        ...
        // console.log("checkoutData");
            return {...data, checkoutData: action?.data?.data?.map((data) => ({...data})),
