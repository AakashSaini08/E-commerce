        ...
        <div className="w-30 ">
          <div className='signup-box p-5 row-2' >
            <div className="column  rounded-4   ">
              <h1 className=" signup-head text-dark p-3 text-center  rounded-bottom rounded-4 text-white">Change Password</h1>
              <div className=" px-4 bg-transparent">
                <form className="form-group" >
                  <div className='d-sm-grid gap-1'>
                    <label><b>Reset Password :</b></label>
                    <input type='password' placeholder='abc@123' className="form-control my-2" value={reset_password} onChange={(e) => handleResetPassword(e)} required></input>
                    {errors.reset_password && <p>{errors.reset_password}</p>}
                  </div>
                  <div className='d-sm-grid gap-1'>
                    <label><b>Password :</b></label>
                    <input type='password' placeholder='abc@123' className="form-control my-2" value={confirm_password} onChange={(e) => handleConfirmPassword(e)} required></input>
